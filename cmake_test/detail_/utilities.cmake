...
function(_ct_get_value _gv_value _gv_handle _gv_prop)
    ...
    message("Getting ${_gv_name} with value ${${_gv_name}}")
    set(${_gv_value} "${${_gv_name}}" PARENT_SCOPE)
endfunction()

function(_ct_set_value _sv_handle _sv_prop _sv_value)
    set(_sv_name "${_sv_handle}_${_sv_prop}")
    message("Setting ${_sv_name} to ${_sv_value}")
    set(${_sv_name} "${_sv_value}" CACHE INTERNAL "${_sv_name}")
endfunction()
